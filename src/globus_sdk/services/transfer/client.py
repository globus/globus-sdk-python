    ...
    **Paginated Calls**
    ...
    def create_tunnel(
        ...
        *,
        ...
        if (
            "submission_id" not in data["data"]["attributes"]
            or data["data"]["attributes"]["submission_id"] is MISSING
        ):
            log.debug("create_tunnel autofetching submission_id")
            data["data"]["attributes"]["submission_id"] = self.get_submission_id()[
                "value"
            ]
        r = self.post("/v2/tunnels", data=data, query_params=query_params)
        return r
    ...
    def update_tunnel(
        ...
        *,
        ...
        """
        r = self.patch(
            f"/v2/tunnels/{tunnel_id}", data=update_doc, query_params=query_params
        )
        return r
    ...
    def show_tunnel(
        ...
        *,
        ...
        """
        log.debug("TransferClient.show_tunnel(...)")
    ...
    def delete_tunnel(
        ...
        *,
        ...
        r = self.delete(f"/v2/tunnels/{tunnel_id}", query_params=query_params)
        return r
        ...
        *,
        ...
        .. tab-set::
            ...
            .. tab-item:: API Info
                ...
                ``GET /stream_access_points/<stream_ap_id>``
        """
