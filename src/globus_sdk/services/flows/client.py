...
class FlowsClient(client.BaseClient):
    ...
    def create_flow(
        ...
        subtitle: str | None | MissingType = MISSING,
        description: str | None | MissingType = MISSING,
        flow_viewers: list[str] | None | MissingType = MISSING,
        flow_starters: list[str] | None | MissingType = MISSING,
        flow_administrators: list[str] | None | MissingType = MISSING,
        run_managers: list[str] | None | MissingType = MISSING,
        run_monitors: list[str] | None | MissingType = MISSING,
        keywords: list[str] | None | MissingType = MISSING,
    ...
    def update_flow(
        ...
        *,
        ...
        definition: dict[str, t.Any] | None | MissingType = MISSING,
        input_schema: dict[str, t.Any] | None | MissingType = MISSING,
        subtitle: str | None | MissingType = MISSING,
        description: str | None | MissingType = MISSING,
        flow_owner: str | None | MissingType = MISSING,
        flow_viewers: list[str] | None | MissingType = MISSING,
        flow_starters: list[str] | None | MissingType = MISSING,
        flow_administrators: list[str] | None | MissingType = MISSING,
        run_managers: list[str] | None | MissingType = MISSING,
    ...
    def update_run(
        ...
        run_id: UUIDLike,
        *,
        label: str | None | MissingType = MISSING,
    ...
    def run_flow(
        ...
        *,
        ...
        activity_notification_policy: (
            dict[str, t.Any] | RunActivityNotificationPolicy | None | MissingType
        ) = MISSING,
        run_monitors: list[str] | None | MissingType = MISSING,
        run_managers: list[str] | None | MissingType = MISSING,
        additional_fields: dict[str, t.Any] | MissingType = MISSING,
